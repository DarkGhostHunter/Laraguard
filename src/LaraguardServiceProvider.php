    ...
    public function boot(Repository $config, Router $router, Dispatcher $dispatcher)
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            if (! class_exists('CreateTwoFactorAuthenticationsTable')) {
                ...
                $this->publishes([
                    __DIR__.'/../database/migrations/create_two_factor_authentications_table.stub' => database_path("/migrations/{$timestamp}_create_two_factor_authentications_table.php"),
                ], 'migrations');
            }
        }
    }
